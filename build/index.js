...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    ...blockProps,
    id: blockID
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, currentDate)));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/cdsfw-current-date","version":"1.0.0","title":"Current Date","category":"text","icon":"calendar-alt","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"current-date","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
